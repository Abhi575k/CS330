...
// int cond_wait (struct cond_t *, struct sleeplock *);
// int cond_signal (struct cond_t *);
// int cond_broadcast (struct cond_t *);

int condsleep(struct cond_t*, struct sleeplock*);
int wakeupone(void *);
...
// void semsleep(struct semaphore *, struct sleeplock *);
