...
go(int which_child)
{
  ...
  int fd = -1;
     ...
     100:	5c4a0a13          	addi	s4,s4,1476 # 16c0 <buf.1248>
    ...
    if(what == 1){
     ...
     518:	952080e7          	jalr	-1710(ra) # e66 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.1248+0xbb>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    139c:	b5e080e7          	jalr	-1186(ra) # ef6 <sbrk>
  if(p == (char*)-1)
