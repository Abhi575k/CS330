...
int main(){
  ...
  1a:	7d250513          	addi	a0,a0,2002 # 7e8 <malloc+0xe4>
  1e:	00000097          	auipc	ra,0x0
  22:	628080e7          	jalr	1576(ra) # 646 <printf>
    // printf("RBW\n");
    exit(0);
  26:	4501                	li	a0,0
...
putc(int fd, char c)
{
 ...
 384:	f46080e7          	jalr	-186(ra) # 2c6 <write>
}
...
free(void *ap)
{
 ...
 68a:	1a27b783          	ld	a5,418(a5) # 828 <freep>
 ...
 6b8:	00e6ea63          	bltu	a3,a4,6cc <free+0x50>
{
 ...
 6fa:	12f73923          	sd	a5,306(a4) # 828 <freep>
}
 6fe:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72c:	10053503          	ld	a0,256(a0) # 828 <freep>
 ...
 754:	0d890913          	addi	s2,s2,216 # 828 <freep>
  if(p == (char*)-1)
 758:	5afd                	li	s5,-1
 75a:	a88d                	j	7cc <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 75c:	00000797          	auipc	a5,0x0
 760:	0d478793          	addi	a5,a5,212 # 830 <base>
 764:	00000717          	auipc	a4,0x0
 768:	0cf73223          	sd	a5,196(a4) # 828 <freep>
 76c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78e:	08a73f23          	sd	a0,158(a4) # 828 <freep>
      return (void*)(p + 1);
 ...
 7dc:	b5e080e7          	jalr	-1186(ra) # 336 <sbrk>
  if(p == (char*)-1)
