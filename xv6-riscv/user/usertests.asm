...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124a:	45a78793          	addi	a5,a5,1114 # 86a0 <big.1281>
...
0000000000002236 <bigargtest>:
{
  ...
  close(fd);
    ...
    229e:	30678793          	addi	a5,a5,774 # 85a0 <args.1870>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3f668693          	addi	a3,a3,1014 # 8698 <args.1870+0xf8>
    ...
    22be:	2e658593          	addi	a1,a1,742 # 85a0 <args.1870>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d88:	b5e080e7          	jalr	-1186(ra) # 58e2 <sbrk>
  if(p == (char*)-1)
