...
user/_rbw:     file format elf64-littleriscv
...
int main(){
  ...
  10:	706080e7          	jalr	1798(ra) # 712 <malloc>
  14:	84aa                	mv	s1,a0
    printf("Virtual Addr: %x\n",p);
  16:	85aa                	mv	a1,a0
  18:	00000517          	auipc	a0,0x0
  1c:	7e050513          	addi	a0,a0,2016 # 7f8 <malloc+0xe6>
  20:	00000097          	auipc	ra,0x0
  24:	634080e7          	jalr	1588(ra) # 654 <printf>
    printf("Physical Addr: %x\n",getpa(p));
  28:	8526                	mv	a0,s1
  2a:	00000097          	auipc	ra,0x0
  2e:	34a080e7          	jalr	842(ra) # 374 <getpa>
  32:	85aa                	mv	a1,a0
  34:	00000517          	auipc	a0,0x0
  38:	7dc50513          	addi	a0,a0,2012 # 810 <malloc+0xfe>
  3c:	00000097          	auipc	ra,0x0
  40:	618080e7          	jalr	1560(ra) # 654 <printf>
    exit(0);
  44:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c4:	47050513          	addi	a0,a0,1136 # 830 <digits>
 3c8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 490:	3a4b8b93          	addi	s7,s7,932 # 830 <digits>
 ...
 5d0:	25c90913          	addi	s2,s2,604 # 828 <malloc+0x116>
        while(*s != 0){
...
free(void *ap)
{
 ...
 698:	1b47b783          	ld	a5,436(a5) # 848 <freep>
 ...
 6c6:	00e6ea63          	bltu	a3,a4,6da <free+0x50>
{
 ...
 708:	14f73223          	sd	a5,324(a4) # 848 <freep>
}
 70c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 73a:	11253503          	ld	a0,274(a0) # 848 <freep>
 ...
 762:	0ea90913          	addi	s2,s2,234 # 848 <freep>
  if(p == (char*)-1)
 766:	5afd                	li	s5,-1
 768:	a88d                	j	7da <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 76a:	00000797          	auipc	a5,0x0
 76e:	0e678793          	addi	a5,a5,230 # 850 <base>
 772:	00000717          	auipc	a4,0x0
 776:	0cf73b23          	sd	a5,214(a4) # 848 <freep>
 77a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 79c:	0aa73823          	sd	a0,176(a4) # 848 <freep>
      return (void*)(p + 1);
